  ...
  render(){
    ...
    return(
      <form onSubmit={handleSubmit(this.onFormSubmit.bind(this))}>
        ...
        <div className={`form-group ${categories.touched && categories.invalid ? "has-danger" : null}`}>
        ...
        <div className={`form-group ${content.touched && content.invalid ? "has-danger" : null}`}>
          <label>Content</label>
